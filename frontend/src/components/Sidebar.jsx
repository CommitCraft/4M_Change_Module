...
const Sidebar = ({ isOpen }) => {
  ...
  const menuItems = [
    ...
    { path: '/implementation', label: 'Implementation', icon: FaTools, permission: 'changes.implement', roles: ['Admin', 'SuperAdmin'] },
    { path: '/monitoring', label: 'Monitoring', icon: FaChartLine, permission: 'changes.monitor', roles: ['Admin', 'SuperAdmin'] },
